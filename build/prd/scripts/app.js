...
/***/ function(module, exports) {
	...
	module.exports = "<script id=\"test\" type=\"text/html\">  <h1>{{title}}</h1>  <ul>      {{each list as value i}}          <li>索引 {{i + 1}} ：{{value}}</li>      {{/each}}  </ul></script>"

/***/ },
/* 6 */
/***/ function(module, exports) {

	module.exports = "<header>	<div><img src=\"./images/top_search_logo.png\" alt=\"\"></div>	<form>		<input id=\"top_search\" type=\"button\">		<input id=\"top_listBar\" type=\"button\">	</form></header>"
